...
@Constraint(validatedBy = PermissionValidator.CustomerTypeValidator.class)
public @interface PermissionValidator {
    ...
    class CustomerTypeValidator implements ConstraintValidator<PermissionValidator, String> {
        @Override
        public boolean isValid(String value, ConstraintValidatorContext context) {
            ...
            return value.equals(Permissions.NORMAL.name()) ||
                    value.equals(Permissions.BUSINESS.name()) ||
                    value.equals(Permissions.VIP.name());
        }
        enum  Permissions {
            NORMAL,
            BUSINESS,
